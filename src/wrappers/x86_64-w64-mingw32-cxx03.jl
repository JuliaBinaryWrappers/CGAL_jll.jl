# Autogenerated wrapper script for CGAL_jll for x86_64-w64-mingw32-cxx03
export libCGAL_ImageIO, libCGAL, libCGAL_Core
...
const libCGAL_ImageIO_splitpath = ["bin", "libCGAL_ImageIO.dll"]
...
const libCGAL_ImageIO = "libCGAL_ImageIO.dll"


# Relative path to `libCGAL`
const libCGAL_splitpath = ["bin", "libCGAL.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libCGAL = "libCGAL.dll"


# Relative path to `libCGAL_Core`
const libCGAL_Core_splitpath = ["bin", "libCGAL_Core.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libCGAL_Core = "libCGAL_Core.dll"
